  ...
  <body class="background-home">
    ...
    <div class="main-container-information-container">
      <div class="main-info-sub-container">
        ...
        <div class="sub-text">Being a 5 rated restaurant in hygeine, <p> we can guarantee you that the highest quality raw materials
    ...
    <footer class="main-footer">
      <div class="footer-logo-container">
        ...
        <center>
          <br>
          <p class="logo-under-heading">Restaurant Like <span class="italic-heading">Experience</span> at home !</p>
        </center>
      </div>
      <div class="footer-main-menu-container">
        <div class="footer-sub-container">
          ...
          <ul>
            <li>
              <a href="">Address: <span>Aston University, Birmingham</span>
              </a>
            </li>
            <li>
              <a href="">Phone: <span>+44 1234567890</span>
              </a>
            </li>
            <li>
              <a href="">Hours: <span>Hours: 10:00 - 18:00, Mon - Sat</span>
              </a>
            </li>
          </ul>
        </div>
